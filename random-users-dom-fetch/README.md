# MOD 04 - Random Users DOM fetch

<div align="right">
<a href="https://davorpa.github.io/hab-m04/random-users-dom-fetch" title="Ver en vivo">
...
mkdir random-users-dom-fetch && cd random-users-dom-fetch

# Agregamos contenido
echo "# MOD 04 - Random Users DOM fetch" >> README.md

## Agregamos al repositorio
git add --all
git commit -m "🎉 Commit inicial. MOD 04 - Random Users DOM fetch"
...
## Agregamos al repositorio
git add --all
git commit -m "📝 Init proyecto. MOD 04 - Random Users DOM fetch"
...
<head>
    ...
    <title>Random Users DOM fetch</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <h1>Random Users DOM fetch</h1>
